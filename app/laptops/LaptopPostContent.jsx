...
export default function LaptopPostContent() {
  ...
  const [laptopOperating, setLaptopOperating] = useState("");
  ...
  useEffect(() => {
    ...
    if (!isEditMode && isDraftMode && !idToUse) {
     ...
     let carAd = null;
       ...
       setLaptopProcessor(laptopAd.laptopProcessor || "");
       setLaptopRam(laptopAd.laptopRam || "");
       setLaptopStorage(laptopAd.laptopStorage || "");
       setLaptopOperating(laptopAd.laptopOperating || "");
       setLaptopScreenSize(laptopAd.laptopScreenSize || "");
       setLaptopBatteryHealth(laptopAd.laptopBatteryHealth || "");
       setLaptopColor(laptopAd.laptopColor || "");
       setLaptopAccessories(laptopAd.laptopAccessories || "");
     ...
     const businessId = laptopAd.businessCategory?._id 
       ...
       setEditingCarAd({
         ...
         category: carAd?.category || 'Laptops',
  ...
  const submitAd = useCallback(async (planToSubmit, useWallet = false) => {
    ...
    laptopTitle,  condition, laptopBrand, laptopProcessor, laptopRam, laptopStorage, laptopOperating, laptopScreenSize, laptopBatteryHealth, laptopColor, laptopAccessories, laptopWarranty, amount, negotiation, business, description,
    ...
    <>
      <div className="bg-white shadow-phenom rounded-[12px] p-5 md:p-10">
        ...
        <h3 className="text-[#525252] font-[500] font-inter text-[16px] mb-4 text-left md:text-center">
          {editingCarAd ? "Complete Your Post Computer Accessories Ad" : "Post Computer Accessories Ad"}
        </h3>
        ...
        <form>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
            ...
            <InputField
              ...
              placeholder="e.g Intel Core i3 or M1"
            />

              <PostDropdown 
             label="RAM (Optional)"
             value={laptopRam}
             onChange={setLaptopRam}
             options={[
              "1 GB",
              "2 GB",
              "4 Gb",
            ...
            <PostDropdown 
              ...
              value={laptopOperating}
              onChange={setLaptopOperating}
              options={[
                "Chrome OS",
                "Harmony OS",
                "Linux",
            ...
            <InputField 
              ...
              value={laptopBatteryHealth}
              onChange={(e) => setLaptopBatteryHealth(e.target.value)}
            />
            ...
            <InputField
               ...
               placeholder="e.g mouse, charger, bag"
               value={laptopAccessories}
               onChange={(e) => setLaptopAccessories(e.target.value)}
            />
