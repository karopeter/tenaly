...
import ConstructionSafetyPostContent from "./ConstructionSafetyPostContent";
...
const sectionComponents = {
  ...
  "Create ConstructionSafety": <ConstructionSafetyPostContent />,
...
export default function Content({ activeSection, setActiveSection, isMobile }) {
  ...
  const renderContent = () => {
    ...
    if (!activeSection) {
      return sectionComponents["Create ConstructionSafety"];
    }
