...
export default function ConstructionEquipmentBuildingPost() {
    const [activeSection, setActiveSection] = useState("Create ConstructionEquipmentBuilding");
    ...
    return (
      <div className="md:px-[104px] px-4 md:ml-10 mt-20 md:mt-40">
        <div className="flex flex-col md:flex-row gap-6">
          ...
          {/* This fix; Wrapping content is a Suspense boundary */}
          <Suspense fallback={<div>Loading dog post content...</div>}>
            <Content 
               activeSection={activeSection}
               setActiveSection={setActiveSection}
               isMobile={isMobile}
