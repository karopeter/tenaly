...
export default function ConstructionEquipmentBuildingPostContent() {
  ...
  useEffect(() => {
    ...
    if (!isEditMode && isDraftMode && !idToUse) {
     ...
     let carAd = null;
       ...
       setPowerRating(constructionAd.powerRating || "");
       setCondition(constructionAd.condition || "");
       setWarranty(constructionAd.warranty || "");
  ...
  const submitAd = useCallback(async (planToSubmit, useWallet = false) => {
   ...
   constructionTitle, constructionType, constructionBrand, powerRating, condition, warranty,  amount, negotiation, business, description,
    ...
    <>
      <div className="bg-white shadow-phenom rounded-[12px] p-5 md:p-10">
        ...
        <h3 className="text-[#525252] font-[500] font-inter text-[16px] mb-4 text-left md:text-center">
          {editingCarAd ? "Complete Your Building Construction Equipment Material Ad" : "Post Construction Equipment Material Ad"}
        </h3>
