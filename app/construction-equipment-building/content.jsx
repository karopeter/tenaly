...
import ConstructionEquipmentBuildingPostContent from "./ConstructionEquipmentBuildingPostContent";
...
const sectionComponents = {
  ...
  "Create ConstructionEquipmentBuilding": <ConstructionEquipmentBuildingPostContent />,
...
export default function Content({ activeSection, setActiveSection, isMobile }) {
  ...
  const renderContent = () => {
    ...
    if (!activeSection) {
      return sectionComponents["Create ConstructionEquipmentBuilding"];
    }
