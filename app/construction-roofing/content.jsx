...
import ConstructionRoofingPostContent from "./ConstructionRoofingPostContent";
...
const sectionComponents = {
  ...
  "Create ConstructionRoofing": <ConstructionRoofingPostContent />,
...
export default function Content({ activeSection, setActiveSection, isMobile }) {
  ...
  const renderContent = () => {
    ...
    if (!activeSection) {
      return sectionComponents["Create ConstructionRoofing"];
    }
