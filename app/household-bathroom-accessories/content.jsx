...
import HouseholdBathroomPostContent from "./HouseholdBathroomPostContent";
...
const sectionComponents = {
  ...
  "Create HBathroom": <HouseholdBathroomPostContent />,
...
export default function Content({ activeSection, setActiveSection, isMobile }) {
  ...
  const renderContent = () => {
    ...
    if (!activeSection) {
      return sectionComponents["Create HBathroom"];
    }
