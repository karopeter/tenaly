...
import FashionAccessoriesPostContent from "./FashionAccessoriesPostContent";
...
const sectionComponents = {
  ...
  "Create FAccessories": <FashionAccessoriesPostContent />,
...
export default function Content({ activeSection, setActiveSection, isMobile }) {
  ...
  const renderContent = () => {
    ...
    if (!activeSection) {
      return sectionComponents["Create FAccessories"];
    }
