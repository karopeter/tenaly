...
import GadgetScreenProtectorPostContent from "./GadgetScreenProtector";
...
const sectionComponents = {
  ...
  "Create ScreenProtector": <GadgetScreenProtectorPostContent />,
...
export default function Content({ activeSection, setActiveSection, isMobile }) {
  ...
  const renderContent = () => {
    ...
    if (!activeSection) {
      return sectionComponents["Create ScreenProtector"];
    }
