...
import ViewPropertyAddContent from "../view-property-add/ViewPropertyAddContent";
import ViewVehicleAddContent from "./ViewVehicleAddContent";
...
const sectionComponents = {
  ...
  "View VehicleAdd": <ViewVehicleAddContent />,
...
export default function Content({ activeSection, setActiveSection, isMobile }) {
  ...
  const renderContent = () => {
    ...
    if (!activeSection) {
      return sectionComponents["View VehicleAdd"];
    }
