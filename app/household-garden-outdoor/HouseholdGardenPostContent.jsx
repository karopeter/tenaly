...
export default function HouseholdGardenPostContent() {
    ...
    if (!isEditMode && isDraftMode && !idToUse) {
     ...
     const businessId = householdAd.businessCategory?._id 
       ...
       setEditingCarAd({
         ...
         category: carAd?.category || 'Garden & Outdoor',
  ...
  const submitAd = useCallback(async (planToSubmit, useWallet = false) => {
    ...
    householdTitle, householdType, condition, size, householdPowersource, householdMaterial, householdColor, amount, negotiation, business, description,
    ...
    <>
      <div className="bg-white shadow-phenom rounded-[12px] p-5 md:p-10">
        ...
        <h3 className="text-[#525252] font-[500] font-inter text-[16px] mb-4 text-left md:text-center">
          {editingCarAd ? "Complete Your Garden Outdoor Ad" : "Post Garden Outdoor Ad"}
        </h3>
        ...
        <form>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
            ...
            <InputField 
              label="Power Source (Optional)"
              value={householdPowersource}
              onChange={(e) => setHouseholdPowersource(e.target.value)}
              placeholder="Enter"
            />
