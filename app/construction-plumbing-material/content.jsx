...
import ConstructionPlumbingPostContent from "./ConstructionPlumbingPostContent";
...
const sectionComponents = {
  ...
  "Create ConstructionPlumber": <ConstructionPlumbingPostContent />,
...
export default function Content({ activeSection, setActiveSection, isMobile }) {
  ...
  const renderContent = () => {
    ...
    if (!activeSection) {
      return sectionComponents["Create ConstructionPlumber"];
    }
