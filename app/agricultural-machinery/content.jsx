...
import AgriculturalMachineryPostContent from "./MachineryPostContent";
...
const sectionComponents = {
  ...
  "Create Machinery": <AgriculturalMachineryPostContent />,
...
export default function Content({ activeSection, setActiveSection, isMobile }) {
  ...
  const renderContent = () => {
    ...
    if (!activeSection) {
      return sectionComponents["Create Machinery"];
    }
