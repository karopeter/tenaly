...
import ConstructionHandPostContent from "./ConstructionHandPostContent";
...
const sectionComponents = {
  ...
  "Create ConstructionHand": <ConstructionHandPostContent />,
...
export default function Content({ activeSection, setActiveSection, isMobile }) {
  ...
  const renderContent = () => {
    ...
    if (!activeSection) {
      return sectionComponents["Create ConstructionHand"];
    }
