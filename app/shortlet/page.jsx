...
const planDetails = {
 ...
 const buildPayload = (planType) => ({
  ...
  }, [propertyName, propertyAddress, propertyType, furnishing, propertyCondition, parking, squareMeter, ownershipStatus, serviceCharge, serviceFee, amount, negotiation, business, description, token, login, router]);
