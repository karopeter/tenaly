...
import ConstructionEquipmentPostContent from "./ConstructionEquipmentPostContent";
...
const sectionComponents = {
  ...
  "Create ConstructionEquipment": <ConstructionEquipmentPostContent />,
...
export default function Content({ activeSection, setActiveSection, isMobile }) {
  ...
  const renderContent = () => {
    ...
    if (!activeSection) {
      return sectionComponents["Create ConstructionEquipment"];
    }
