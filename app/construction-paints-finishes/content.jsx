...
import ConstructionPaintPostContent from "./ConstructionPaintPostContent";
...
const sectionComponents = {
  ...
  "Create ConstructionPaints": <ConstructionPaintPostContent />,
...
export default function Content({ activeSection, setActiveSection, isMobile }) {
  ...
  const renderContent = () => {
    ...
    if (!activeSection) {
      return sectionComponents["Create ConstructionPaints"];
    }
