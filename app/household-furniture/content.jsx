...
import HouseholdFurniturePostContent from "./HouseholdFurniturePostContent";
...
const sectionComponents = {
  ...
  "Create Furniture": <HouseholdFurniturePostContent />,
...
export default function Content({ activeSection, setActiveSection, isMobile }) {
  ...
  const renderContent = () => {
    ...
    if (!activeSection) {
      return sectionComponents["Create Furniture"];
    }
