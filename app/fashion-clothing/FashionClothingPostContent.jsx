...
export default function FashionClothingPostContent() {
 ...
 const [fashionColor, setFashionColor] = useState("");
  ...
  useEffect(() => {
    ...
    if (!isEditMode && isDraftMode && !idToUse) {
     ...
     let carAd = null;
       ...
       setSize(fashionAd.size || "");
       setFashionMaterial(fashionAd.fashionMaterial || "");
     ...
     const businessId = fashionAd.businessCategory?._id 
       ...
       setEditingCarAd({
         ...
         category: carAd?.category || 'Clothing',
  ...
  const submitAd = useCallback(async (planToSubmit, useWallet = false) => {
    ...
    fashionTitle, fashionType, condition, fashionBrand, gender, size, fashionMaterial, fashionColor,  amount, negotiation, business, description,
    ...
    <>
      <div className="bg-white shadow-phenom rounded-[12px] p-5 md:p-10">
        ...
        <h3 className="text-[#525252] font-[500] font-inter text-[16px] mb-4 text-left md:text-center">
          {editingCarAd ? "Complete Your Clothing Ad" : "Post Clothing Ad"}
        </h3>
