...
export default function CatPostContent() {
        ...
        <form>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
            ...
            <PostDropdown
              ...
              value={breed}
              onChange={setBreed}
              options={["Short Haired", "American Shorthair", "Ragdoll", "Nirman", "Sphynx", "LaPerm", "Singapura"]}
            />
            <InputField
              label="Age"
              value={age}
