...
import KidsSchoolSupplyPostContent from "./KidsSchoolSupplyContent";
...
const sectionComponents = {
  ...
  "Create Babysupply": <KidsSchoolSupplyPostContent />,
...
export default function Content({ activeSection, setActiveSection, isMobile }) {
  ...
  const renderContent = () => {
    ...
    if (!activeSection) {
      return sectionComponents["Create Babysupply"];
    }
