...
import BeautyFragrancePostContent from "./BeautyFragrancesPostContent";
...
const sectionComponents = {
  ...
  "Create BeautyFragrances": <BeautyFragrancePostContent />,
...
export default function Content({ activeSection, setActiveSection, isMobile }) {
  ...
  const renderContent = () => {
    ...
    if (!activeSection) {
      return sectionComponents["Create BeautyFragrances"];
    }
