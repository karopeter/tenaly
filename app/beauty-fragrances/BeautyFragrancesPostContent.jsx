...
export default function BeautyFragrancePostContent() {
  ...
  useEffect(() => {
    ...
    if (!isEditMode && isDraftMode && !idToUse) {
     ...
     let carAd = null;
       ...
       setFragranceFamily(beautyAd.fragranceFamily || "");
     ...
     const businessId = beautyAd.businessCategory?._id 
       ...
       setEditingCarAd({
         ...
         category: carAd?.category || 'Fragrances (Perfume & Body Spray)',
  ...
  const submitAd = useCallback(async (planToSubmit, useWallet = false) => {
   ...
   beautyTitle, beautyType, condition, fragranceFamily, gender, beautyBrand, amount, negotiation, business, description,
    ...
    <>
      <div className="bg-white shadow-phenom rounded-[12px] p-5 md:p-10">
        ...
        <h3 className="text-[#525252] font-[500] font-inter text-[16px] mb-4 text-left md:text-center">
          {editingCarAd ? "Complete Your Fragrances  Ad" : "Post Fragrances Ad"}
        </h3>
