...
import TabletAccessoriesPostContent from "./TabletAccessoriesPostContent";
...
const sectionComponents = {
  ...
  "Create GTAccessories": <TabletAccessoriesPostContent />,
...
export default function Content({ activeSection, setActiveSection, isMobile }) {
  ...
  const renderContent = () => {
    ...
    if (!activeSection) {
      return sectionComponents["Create GTAccessories"];
    }
