...
import HouseholdKitchenwarePostContent from "./HouseholdKitchenwarePostContent";
...
const sectionComponents = {
  ...
  "Create Kitchenware": <HouseholdKitchenwarePostContent />,
...
export default function Content({ activeSection, setActiveSection, isMobile }) {
  ...
  const renderContent = () => {
    ...
    if (!activeSection) {
      return sectionComponents["Create Kitchenware"];
    }
