...
export default function FashionJewelleryPostContent() {
 ...
 const [fashionMaterial, setFashionMaterial] = useState("");
    ...
    if (!isEditMode && isDraftMode && !idToUse) {
     ...
     const businessId = fashionAd.businessCategory?._id 
       ...
       setEditingCarAd({
         ...
         category: carAd?.category || 'Jewellery',
  ...
  const submitAd = useCallback(async (planToSubmit, useWallet = false) => {
    ...
    fashionTitle, fashionType, condition, fashionBrand, gender, fashionMaterial, amount, negotiation, business, description,
    ...
    <>
      <div className="bg-white shadow-phenom rounded-[12px] p-5 md:p-10">
        ...
        <h3 className="text-[#525252] font-[500] font-inter text-[16px] mb-4 text-left md:text-center">
          {editingCarAd ? "Complete Your Jewelry  Ad" : "Post Jewelry Ad"}
        </h3>
