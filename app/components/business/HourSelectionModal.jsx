...
export default function HourSelectionModal({ business, onClose, onSelectMode }) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="relative bg-white rounded-[24px] p-6 max-w-md text-center shadow-xl">
        <Button
          onClick={onClose}
        ...
        <div className="flex flex-col gap-3 mt-4">
          <Button
            ...
            md:w-[347px] md:h-[52px] rounded-[8px] text-[16px] font-[500] font-inter"
            onClick={() => onSelectMode("same")}
          >
            Yes, they have the same business hours
          </Button>
          <Button
            className="border border-[#CDCDD7] md:w-[347px] md:h-[52px] rounded-[8px] text-[#525252] text-[16px] font-[500] font-inter"
