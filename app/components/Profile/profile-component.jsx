...
import AddBusiness from "../addBusiness/add.business";
import BusinessForm from "../BusinessForm/business-form";
import AddBusinessHourss from "../addBusinessHours/add-busi-hours";

export default function ProfileComponent({ createBusinessPage, addBusiness, businessHours }) {
  ...
  // State for determinng if the profile is selected from the sidebar 
