...
// Helper component for rendering address fields
...
export default function EditBussinessPage() {
    ...
    const fetchBusiness = async () => {
      try {
        ...
        if (data) {
          ...
          // Map over the array of address objects to get an array of address strings
          if (Array.isArray(data.addresses)) {
            setAddresses(data.addresses.map(addrObj => addrObj.address) || []);
            ...
            setBusiness(null); // Explicitly set to null if no data is found
        }
      } catch (err) {
  ...
  const handleUpdateBusiness = async () => {
    ...
    try {
      ...
      const currentAddresses = Array.isArray(business.addresses) ? business.addresses.map(a => a.address) : [];
