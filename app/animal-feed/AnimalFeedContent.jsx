...
export default function AnimalFeedContent() {
    ...
    <>
      <div className="bg-white shadow-phenom rounded-[12px] p-5 md:p-10">
        ...
        <h3 className="text-[#525252] font-[500] font-inter text-[16px] mb-4 text-left md:text-center">
          {editingCarAd ? "Complete Your Agriculture Ad" : "Post Animal feed Ad"}
        </h3>
        ...
        <form>
          ...
          <div className="mt-4">
            ...
            <textarea
              placeholder="Enter the description of the Animal Feed"
              value={description}
