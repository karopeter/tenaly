...
import AgricultureProduceContent from "./AgricultureProduceContent";
...
const sectionComponents = {
  ...
  "Create Agriculture": <AgricultureProduceContent />,
...
export default function Content({ activeSection, setActiveSection, isMobile }) {
  ...
  const renderContent = () => {
    ...
    if (!activeSection) {
      return sectionComponents["Create Agriculture"];
    }
