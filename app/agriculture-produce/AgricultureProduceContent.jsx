...
export default function AgricultureProduceContent() {
    ...
    const fetchDraftData = async () => {
      ...
      try {
        ...
        setEditingCarAd({
          ...
          category: carAd?.category || 'Fresh Produce (fruits, vegetables, grains)',
...
const handleRemoveBulkPrice = (index) => {
  ...
  const submitAd = useCallback(async (planToSubmit, useWallet = false) => {
    ...
    bulkPrices, token, login, router, editingCarAd, carAdId, buildPayload
  ]);
  ...
  const handleSaveAsDraft = useCallback(async () => {
    try {
      ...
      toast.success(`Agriculture ad saved as draft with ${savedPlan} plan!`);
    ...
    <>
      <div className="bg-white shadow-phenom rounded-[12px] p-5 md:p-10">
        ...
        <h3 className="text-[#525252] font-[500] font-inter text-[16px] mb-4 text-left md:text-center">
          {editingCarAd ? "Complete Your Agriculture Ad" : "Post an Agriculture & Food Ad"}
        </h3>
