...
import BeautyHaircarePostContent from "./BeautyHaircarePostContent";
...
const sectionComponents = {
  ...
  "Create BeautyHaircare": <BeautyHaircarePostContent />,
...
export default function Content({ activeSection, setActiveSection, isMobile }) {
  ...
  const renderContent = () => {
    ...
    if (!activeSection) {
      return sectionComponents["Create BeautyHaircare"];
    }
