...
import ConstructionRepairPostContent from "./ConstructionRepairPostContent";
...
const sectionComponents = {
  ...
  "Create ConstructionRepair": <ConstructionRepairPostContent />,
...
export default function Content({ activeSection, setActiveSection, isMobile }) {
  ...
  const renderContent = () => {
    ...
    if (!activeSection) {
      return sectionComponents["Create ConstructionRepair"];
    }
