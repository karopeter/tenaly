...
import ConstructionBuildingPostContent from "./ConstructionBuildingPostContent";
...
const sectionComponents = {
  ...
  "Create ConstructionBuilding": <ConstructionBuildingPostContent />,
...
export default function Content({ activeSection, setActiveSection, isMobile }) {
  ...
  const renderContent = () => {
    ...
    if (!activeSection) {
      return sectionComponents["Create ConstructionBuilding"];
    }
