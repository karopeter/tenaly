...
export default function ConstructionBuildingPostContent() {
    ...
    if (!isEditMode && isDraftMode && !idToUse) {
     ...
     const businessId = constructionAd.businessCategory?._id 
       ...
       setEditingCarAd({
         ...
         category: carAd?.category || 'Building Material',
  ...
  const submitAd = useCallback(async (planToSubmit, useWallet = false) => {
   ...
   constructionTitle, constructionType, constructionMaterial, constructionUnit, constructionBrand,  amount, negotiation, business, description,
    ...
    <>
      <div className="bg-white shadow-phenom rounded-[12px] p-5 md:p-10">
        ...
        <h3 className="text-[#525252] font-[500] font-inter text-[16px] mb-4 text-left md:text-center">
          {editingCarAd ? "Complete Your Building Material Ad" : "Post Building Material Ad"}
        </h3>
