...
import BeautyMenGroomingPostContent from "./BeautyMenGroomingPostContent";
...
const sectionComponents = {
  ...
  "Create Mengrooming": <BeautyMenGroomingPostContent />,
...
export default function Content({ activeSection, setActiveSection, isMobile }) {
  ...
  const renderContent = () => {
    ...
    if (!activeSection) {
      return sectionComponents["Create Mengrooming"];
    }
