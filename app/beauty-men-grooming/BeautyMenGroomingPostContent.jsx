...
export default function BeautyMenGroomingPostContent() {
    ...
    if (!isEditMode && isDraftMode && !idToUse) {
     ...
     const businessId = beautyAd.businessCategory?._id 
       ...
       setEditingCarAd({
         ...
         category: carAd?.category || "Men's Grooming",
  ...
  const submitAd = useCallback(async (planToSubmit, useWallet = false) => {
   ...
   beautyTitle, beautyType, condition, beautyBrand, amount, negotiation, business, description,
