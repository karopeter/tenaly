...
import HouseholdCurtainsPostContent from "./HouseholdCurtainsPostContent";
...
const sectionComponents = {
  ...
  "Create Curtains": <HouseholdCurtainsPostContent />,
...
export default function Content({ activeSection, setActiveSection, isMobile }) {
  ...
  const renderContent = () => {
    ...
    if (!activeSection) {
      return sectionComponents["Create Curtains"];
    }
