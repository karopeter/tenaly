...
export default function HouseholdCurtainsPostContent() {
 ...
 const [householdMaterial, setHouseholdMaterial] = useState("");
  ...
  const submitAd = useCallback(async (planToSubmit, useWallet = false) => {
    ...
    householdTitle, householdType, condition, householdBrand, size, householdMaterial, householdColor, amount, negotiation, business, description,
    ...
    <>
      <div className="bg-white shadow-phenom rounded-[12px] p-5 md:p-10">
        ...
        <h3 className="text-[#525252] font-[500] font-inter text-[16px] mb-4 text-left md:text-center">
          {editingCarAd ? "Complete Your Curtains & Blinds Ad" : "Post Curtains & Blinds Ad"}
        </h3>
