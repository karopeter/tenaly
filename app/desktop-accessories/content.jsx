...
import DesktopAccessoriesPostContent from "./DesktopAccessoriesPostContent";
...
const sectionComponents = {
  ...
  "Create DAccessories": <DesktopAccessoriesPostContent />,
...
export default function Content({ activeSection, setActiveSection, isMobile }) {
  ...
  const renderContent = () => {
    ...
    if (!activeSection) {
      return sectionComponents["Create DAccessories"];
    }
