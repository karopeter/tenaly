    ...
    return (
      <section className="px-4 md:px-10 mt-10 flex flex-col items-center justify-center min-h-[200px]">
         <div className="text-center">
          ...
          <p className="mt-4 text-gray-600 font-inter">Loading Propery Ads...</p>
        </div>
      </section>
    );
  }
      ...
      <div>
         {activeTab === "car" ? (
          <>
           ...
           <div className={`bg-[#FAFAFA] md:w-[650px] md:rounded-[12px] p-8 mt-4 transition-all duration-300 ${
