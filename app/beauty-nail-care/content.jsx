...
import BeautyNailcarePostContent from "./BeautyNailcarePostContent";
...
const sectionComponents = {
  ...
  "Create BeautyNailcare": <BeautyNailcarePostContent />,
...
export default function Content({ activeSection, setActiveSection, isMobile }) {
  ...
  const renderContent = () => {
    ...
    if (!activeSection) {
      return sectionComponents["Create BeautyNailcare"];
    }
