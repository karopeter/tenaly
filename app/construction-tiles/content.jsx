...
import ConstructionTilesPostContent from "./ConstructionTilesPostContent";
...
const sectionComponents = {
  ...
  "Create ConstructionTiles": <ConstructionTilesPostContent />,
...
export default function Content({ activeSection, setActiveSection, isMobile }) {
  ...
  const renderContent = () => {
    ...
    if (!activeSection) {
      return sectionComponents["Create ConstructionTiles"];
    }
