...
import { 
   eventDurationPropertyType, 
   eventGuestOptions,
    eventPropertyTypeOptions, 
...
export default function MorePropertyPost() {
 ...
 const planDetails = {
  ...
  const submitAd = useCallback(async (planToSubmit) => {
    ...
    }, [propertyName, propertyAddress, propertyType, furnishing, parking, squareMeter, ownershipStatus, serviceCharge, serviceFee, propertyDuration, propertyFacilities, amount, guestNumber, negotiation, business, description, token, login, router]); // Added router to dependencies
        ...
        <div className="flex flex-col md:flex-row gap-10">
           ...
           <main className="flex-1">
              ...
              >
                ...
                <h3 className="text-center text-[#525252] fonmt-[500] font-inter md:text-[16px]">Event center and Venues for rent</h3>
                <form>
