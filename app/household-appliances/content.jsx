...
import HouseholdAppliancesPostContent from "./HouseholdAppliancesPostContent";
...
const sectionComponents = {
  ...
  "Create Appliances": <HouseholdAppliancesPostContent />,
...
export default function Content({ activeSection, setActiveSection, isMobile }) {
  ...
  const renderContent = () => {
    ...
    if (!activeSection) {
      return sectionComponents["Create Appliances"];
    }
