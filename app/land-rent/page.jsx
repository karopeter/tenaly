...
export default function MorePropertyPost() {
 ...
 const buildPayload = (planType) => ({
   ...
   const submitAd = useCallback(async (planToSubmit) => {
     ...
     }, [propertyName, propertyAddress, propertyType, propertyFacilities, squareMeter, ownershipStatus, serviceCharge, developmentFee, surveyFee, legalFee, pricingUnits, amount, negotiation, business, description, token, login, router]); // Added router to dependencies
        ...
        <div className="flex flex-col md:flex-row gap-10">
           ...
           <main className="flex-1">
              ...
              >
               ...
               <h3 className="text-center text-[#525252] fonmt-[500] font-inter md:text-[16px]">
