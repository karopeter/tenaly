...
import HouseholdCleaningEquipmentPostContent from "./HouseholdCleaningEquipmentPostContent";
...
const sectionComponents = {
  ...
  "Create CEquipment": <HouseholdCleaningEquipmentPostContent />,
...
export default function Content({ activeSection, setActiveSection, isMobile }) {
  ...
  const renderContent = () => {
    ...
    if (!activeSection) {
      return sectionComponents["Create CEquipment"];
    }
