...
import BeautySkincarePostContent from "./BeautySkincarePostContent";
...
const sectionComponents = {
  ...
  "Create BeautySkincare": <BeautySkincarePostContent />,
...
export default function Content({ activeSection, setActiveSection, isMobile }) {
  ...
  const renderContent = () => {
    ...
    if (!activeSection) {
      return sectionComponents["Create BeautySkincare"];
    }
